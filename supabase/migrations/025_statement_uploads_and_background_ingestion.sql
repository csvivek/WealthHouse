-- ============================================================================
-- Migration: 025_statement_uploads_and_background_ingestion.sql
-- Purpose:   Add upload-parent records for background statement ingestion and
--            link file imports + parse sessions back to the original upload.
-- ============================================================================
...
ALTER TABLE public.file_imports
  ADD COLUMN IF NOT EXISTS statement_upload_id uuid NULL REFERENCES public.statement_uploads(id);
...
ALTER TABLE public.statement_parse_sessions
  ADD COLUMN IF NOT EXISTS statement_upload_id uuid NULL REFERENCES public.statement_uploads(id) ON DELETE CASCADE,
