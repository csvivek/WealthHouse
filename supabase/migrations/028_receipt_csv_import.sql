-- ============================================================================
-- Migration: 028_receipt_csv_import.sql
-- Purpose:   Add CSV batch import support to receipts:
--            - import_source flag on receipt_uploads and receipts tables
--            - receipt_csv_batches table to track batch imports
-- ============================================================================

-- ----------------------------------------------------------------------------
-- 1. import_source column on receipt_uploads
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 2. import_source column on receipts (final committed records)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 3. receipt_csv_batches — tracks each CSV file upload as a batch
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 4. FK: receipt_uploads.csv_batch_id → receipt_csv_batches
-- ----------------------------------------------------------------------------
