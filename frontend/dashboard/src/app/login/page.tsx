...
export default function LoginPage() {
  ...
  return (
    <ExecutiveAuthShell
      title="Operate your household finances from one executive control room."
      description="Track wealth, imports, review flows, and household controls in the same premium workspace."
    >
      ...
      <Card className="border-transparent bg-transparent p-0 shadow-none">
        <CardHeader className="px-0 text-left">
          ...
          <CardDescription className="text-muted-foreground">
            Sign in to continue into your household workspace.
          </CardDescription>
        </CardHeader>
