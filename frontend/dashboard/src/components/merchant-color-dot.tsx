...
import type { MerchantPresentationFields } from './merchant-icon'

function resolveColor({ color_hex, color_token }: Pick<MerchantPresentationFields, 'color_hex' | 'color_token'>) {
...
export function MerchantColorDot({
  className,
  color_hex,
  color_token,
}: Pick<MerchantPresentationFields, 'color_hex' | 'color_token'> & { className?: string }) {
  return (
    <span
